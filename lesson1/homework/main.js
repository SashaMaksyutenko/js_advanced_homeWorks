...
*/
// var changer_fone = document.getElementById('app');
...
function document_loaded() {
    var my_screen = ChangeBgColor();
    document.getElementById('app').innerHTML = ChangeBgColor();
    document.body.style.backgroundColor = my_screen;
}